...
import com.fastsoft.yt.downloader.dl.models.Format;
...
extends AsyncTask<String, Void, SparseArray<YtFile>> {
    ...
    public YoutubeParser(@NonNull Context con) {
    ...
    protected void onPostExecute(SparseArray<YtFile> ytFiles) {
        if(listener != null){
            listener.onExtractSuccess(ytFiles,videoMeta);
        }
    }
    ...
    /**
     * Start Extract Listener
     *
     * @Param OnExtractor Listener Interface
     */
    public YoutubeParser setOnExtractListener(OnExtractListener listener){
    ...
    private SparseArray<YtFile> getStreamUrls() throws IOException, InterruptedException, JSONException {
        ...
        if (mat.find()) {
            ...
            this.videoMeta = new VideoData(videoID,
    ...
    public interface OnExtractListener{
        void onExtractSuccess(SparseArray<YtFile> ytFile,VideoData vData);
